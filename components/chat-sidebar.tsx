...
import { MessageSquare, Plus, Settings, User, X, Trash2, Edit3 } from "lucide-react"
          ...
          <div className="p-4 border-b">
            <div className="flex items-center justify-between">
              ...
              <div className="flex gap-2">
                ...
                <Button size="sm" variant="ghost" onClick={onClose} className="md:hidden">
                  <X className="w-4 h-4" />
                </Button>
              </div>
            </div>
                ...
                >
                  <div className="flex items-start justify-between">
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-gray-500 truncate mb-1">{session.preview}</p>
